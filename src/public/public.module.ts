...
import { LucideAngularModule, CheckCircle, Sun, Moon, Users, Check, FileText, Calendar, Headphones, Download, Receipt, Mail, Link, Copy, CalendarPlus, MapPin, ExternalLink, Clock, Globe, Send, ChevronDown, User, Share, Settings, Crown, MoreHorizontal, Upload, X, LogOut, AlertTriangle, Gift, CreditCard, Sparkles, File, Locate} from 'lucide-angular';
...
@NgModule({
  declarations: [
    ...
    imports: [
      ...
      SharedCommonModule,
      ClipboardModule,
      LucideAngularModule.pick({ CheckCircle, Sun, Moon, Users,Check, FileText, Calendar, Headphones, Download, Receipt, Mail, Link, Copy, CalendarPlus, MapPin,  ExternalLink, Clock, Globe, Send, ChevronDown, User, Share, Settings, Crown, MoreHorizontal, Upload, X, LogOut, AlertTriangle, Gift, CreditCard, Sparkles, File, Locate })
  ],
  providers: [
