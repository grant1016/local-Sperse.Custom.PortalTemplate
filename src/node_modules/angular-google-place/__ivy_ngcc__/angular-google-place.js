...
AngularGooglePlaceConstantService.ɵfac = function AngularGooglePlaceConstantService_Factory(t) { return new (t || AngularGooglePlaceConstantService)(); };
AngularGooglePlaceConstantService.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: AngularGooglePlaceConstantService, factory: AngularGooglePlaceConstantService.ɵfac });
/**
 * @nocollapse
 */
AngularGooglePlaceConstantService.ctorParameters = () => [];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AngularGooglePlaceConstantService, [{
        type: Injectable
...
AngularGooglePlaceService.ɵfac = function AngularGooglePlaceService_Factory(t) { return new (t || AngularGooglePlaceService)(ɵngcc0.ɵɵinject(AngularGooglePlaceConstantService)); };
AngularGooglePlaceService.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: AngularGooglePlaceService, factory: AngularGooglePlaceService.ɵfac });
/**
 * @nocollapse
 */
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AngularGooglePlaceService, [{
        type: Injectable
    }], function () { return [{ type: AngularGooglePlaceConstantService }]; }, null); })();
...
AngularGooglePlaceDirective.ɵfac = function AngularGooglePlaceDirective_Factory(t) { return new (t || AngularGooglePlaceDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(AngularGooglePlaceService), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone)); };
AngularGooglePlaceDirective.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: AngularGooglePlaceDirective, selectors: [["", "angularGooglePlace", ""]], hostBindings: function AngularGooglePlaceDirective_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("focus", function AngularGooglePlaceDirective_focus_HostBindingHandler($event) { return ctx.onFocus($event.target); });
    } }, inputs: { options: "options" }, outputs: { CountryCodes: "CountryCodes", TypesOptions: "TypesOptions", setAddress: "setAddress", FormatAddress: "FormatAddress", street_number: "street_number", postal_code: "postal_code", country: "country", lat: "lat", lng: "lng", adr_address: "adr_address", formatted_address: "formatted_address", name: "name", place_id: "place_id", types: "types", url: "url", utc_offset: "utc_offset", vicinity: "vicinity", photos: "photos", street: "street", city: "city", state: "state", district: "district" } });
/**
 * @nocollapse
 */
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AngularGooglePlaceDirective, [{
        type: Directive,
        args: [{
                selector: '[angularGooglePlace]'
            }]
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: AngularGooglePlaceService }, { type: ɵngcc0.NgZone }]; }, { CountryCodes: [{
            type: Output
        }], TypesOptions: [{
            type: Output
        }], setAddress: [{
...
AngularGooglePlaceModule.ɵfac = function AngularGooglePlaceModule_Factory(t) { return new (t || AngularGooglePlaceModule)(); };
AngularGooglePlaceModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: AngularGooglePlaceModule });
AngularGooglePlaceModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ providers: [AngularGooglePlaceService, AngularGooglePlaceConstantService], imports: [[
            CommonModule
        ]] });
/**
 * @nocollapse
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AngularGooglePlaceModule, [{
        type: NgModule,
        args: [{
                imports: [
                    CommonModule
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(AngularGooglePlaceModule, { declarations: function () { return [AngularGooglePlaceDirective]; }, imports: function () { return [CommonModule]; }, exports: function () { return [AngularGooglePlaceDirective]; } }); })();
